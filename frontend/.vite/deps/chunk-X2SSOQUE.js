...
function useUpdateEffect(callback, deps) {
  const renderCycleRef = (0, import_react18.useRef)(false);
  const effectCycleRef = (0, import_react18.useRef)(false);
...
var PresenceContext = (0, import_react19.createContext)(null);
...
// node_modules/framer-motion/dist/es/utils/use-isomorphic-effect.mjs
var useIsomorphicLayoutEffect = isBrowser4 ? import_react23.useLayoutEffect : import_react23.useEffect;
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component2, props, ref, { latestValues }, isStatic) => {
    ...
    return (0, import_react33.createElement)(Component2, {
      ...elementProps,
...
function createRenderBatcher(scheduleNextBatch, allowKeepAlive) {
  ...
  const processBatch = () => {
    ...
    runNextFrame2 = false;
    state.delta = useDefaultElapsed2 ? 1e3 / 60 : Math.max(Math.min(timestamp - state.timestamp, maxElapsed2), 1);
...
function asRGBA(color2) {
  ...
  invariant2(Boolean(type), `'${color2}' is not an animatable color. Use the equivalent color code instead.`);
...
function test(v) {
  var _a7, _b5;
  return isNaN(v) && isString2(v) && (((_a7 = v.match(floatRegex)) === null || _a7 === void 0 ? void 0 : _a7.length) || 0) + (((_b5 = v.match(colorRegex)) === null || _b5 === void 0 ? void 0 : _b5.length) || 0) > 0;
}
var cssVarTokeniser = {
...
var VisualElementDragControls = class {
  ...
  resolveConstraints() {
    ...
    const layout2 = this.visualElement.projection && !this.visualElement.projection.layout ? this.visualElement.projection.measure(false) : (_a7 = this.visualElement.projection) === null || _a7 === void 0 ? void 0 : _a7.layout;
...
// node_modules/framer-motion/dist/es/motion/features/layout/MeasureLayout.mjs
var MeasureLayoutWithContext = class extends import_react36.default.Component {
  /**
...
function MeasureLayout(props) {
  ...
  return import_react36.default.createElement(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react36.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
...
function useForceUpdate() {
  ...
  const [forcedRenderCount, setForcedRenderCount] = (0, import_react38.useState)(0);
  const forceRender = (0, import_react38.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react38.useCallback)(() => frame2.postRender(forceRender), [forceRender]);
...
function PopChild({ children, isPresent: isPresent2 }) {
  ...
  const size2 = (0, import_react39.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0
...
function useUnmountEffect(callback) {
  return (0, import_react41.useEffect)(() => () => callback(), []);
}
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode: mode2 = "sync" }) => {
  ...
  const forceRender = (0, import_react42.useContext)(LayoutGroupContext).forceRender || useForceUpdate()[0];
  const isMounted = useIsMounted();
  const filteredChildren = onlyElements(children);
  let childrenToRender = filteredChildren;
  const exitingChildren = (0, import_react42.useRef)(/* @__PURE__ */ new Map()).current;
  ...
  return React9.createElement(React9.Fragment, null, exitingChildren.size ? childrenToRender : childrenToRender.map((child) => (0, import_react42.cloneElement)(child)));
};
...
var DeprecatedLayoutGroupContext = (0, import_react45.createContext)(null);
...
function useMotionValue(initial) {
  ...
  if (isStatic) {
    ...
    (0, import_react49.useEffect)(() => value.on("change", setLatest), []);
  }
  return value;
}
...
function ReorderItem({ children, style = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  ...
  return React14.createElement(Component2, { drag: axis, ...props, dragSnapToOrigin: true, style: { ...style, x: point.x, y: point.y, zIndex }, layout: layout2, onDrag: (event, gesturePoint) => {
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-X2SSOQUE.js.map
